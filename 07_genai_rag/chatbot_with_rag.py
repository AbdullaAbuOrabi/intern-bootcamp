...
def build_context_aware_query(user_question):
    """
    Use chat history only when the user asks a follow-up question.
    For direct questions, use the question alone.
    """

    follow_up_words = ["it", "this", "that", "them",
                       "more", "explain", "simpler", "again"]

    question_lower = user_question.lower()

    is_follow_up = any(word in question_lower.split()
